...
class Paginations extends Component {
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        if (this.props.rowsForPage !== prevProps.rowsForPage) {
            this.setPage(this.props.initialPage);
        }
    }
    setPage(page) {
        var { items } = this.props;
        var pageSize = this.props.rowsForPage === '-1' ? items.length : this.props.rowsForPage;
    ...
    render() {
        var pager = this.state.pager;
        // var pages = pager.pages != undefined ? pager.pages : []
